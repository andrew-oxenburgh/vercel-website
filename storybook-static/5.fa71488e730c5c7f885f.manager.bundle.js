...
(window.webpackJsonp = window.webpackJsonp || []).push([[5], {871(module, exports, __webpack_require__) {
	'use strict'; let normalize = __webpack_require__(872); let Schema = __webpack_require__(874); let DefinedInfo = __webpack_require__(875); module.exports = function create(definition) {
	...
	'use strict'; let Info = __webpack_require__(876); let types = __webpack_require__(873); module.exports = DefinedInfo, DefinedInfo.prototype = new Info(), DefinedInfo.prototype.defined = !0; let checks = ['boolean', 'booleanish', 'overloadedBoolean', 'number', 'commaSeparated', 'spaceSeparated', 'commaOrSpaceSeparated']; let checksLength = checks.length; function DefinedInfo(property, attribute, mask, space) {
	...
	'use strict'; let caseSensitiveTransform = __webpack_require__(897); module.exports = function caseInsensitiveTransform(attributes, property) {
	...
	'use strict'; function css(Prism) {
		!(function (Prism) {
			let string = /("|')(?:\\(?:\r\n|[\s\S])|(?!\1)[^\\\r\n])*\1/; Prism.languages.css = {comment: /\/\*[\s\S]*?\*\//, atrule: {pattern: /@[\w-](?:[^;{\s]|\s+(?![\s{]))*(?:;|(?=\s*\{))/, inside: {rule: /^@[\w-]+/, 'selector-function-argument': {pattern: /(\bselector\s*\(\s*(?![\s)]))(?:[^()\s]|\s+(?![\s)])|\((?:[^()]|\([^()]*\))*\))+(?=\s*\))/, lookbehind: !0, alias: 'selector'}, keyword: {pattern: /(^|[^\w-])(?:and|not|only|or)(?![\w-])/, lookbehind: !0}}}, url: {pattern: RegExp('\\burl\\((?:' + string.source + '|' + /(?:[^\\\r\n()"']|\\[\s\S])*/.source + ')\\)', 'i'), greedy: !0, inside: {function: /^url/i, punctuation: /^\(|\)$/, string: {pattern: RegExp('^' + string.source + '$'), alias: 'url'}}}, selector: RegExp('[^{}\\s](?:[^{};"\'\\s]|\\s+(?![\\s{])|' + string.source + ')*(?=\\s*\\{)'), string: {pattern: string, greedy: !0}, property: /(?!\s)[-_a-z\xA0-\uFFFF](?:(?!\s)[-\w\xA0-\uFFFF])*(?=\s*:)/i, important: /!important\b/i, function: /[-a-z0-9]+(?=\()/i, punctuation: /[(){};:,]/}, Prism.languages.css.atrule.inside.rest = Prism.languages.css; let {markup} = Prism.languages; markup && (markup.tag.addInlined('style', 'css'), Prism.languages.insertBefore('inside', 'attr-value', {'style-attr': {pattern: /(^|["'\s])style\s*=\s*(?:"[^"]*"|'[^']*')/i, lookbehind: !0, inside: {'attr-value': {pattern: /=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+)/, inside: {style: {pattern: /(["'])[\s\S]+(?=["']$)/, lookbehind: !0, alias: 'language-css', inside: Prism.languages.css}, punctuation: [{pattern: /^=/, alias: 'attr-equals'}, /"|'/]}}, 'attr-name': /^style/i}}}, markup.tag));
		})(Prism);
	}

	module.exports = css, css.displayName = 'css', css.aliases = [];
}, 881(module, exports, __webpack_require__) {
	let defineProperty = __webpack_require__(205); module.exports = function _objectSpread(target) {
	...
	'use strict'; function jsx(Prism) {
		!(function (Prism) {
			let javascript = Prism.util.clone(Prism.languages.javascript); Prism.languages.jsx = Prism.languages.extend('markup', javascript), Prism.languages.jsx.tag.pattern = /<\/?(?:[\w.:-]+(?:\s+(?:[\w.:$-]+(?:=(?:"(?:\\[^]|[^\\"])*"|'(?:\\[^]|[^\\'])*'|[^\s{'">=]+|\{(?:\{(?:\{[^{}]*\}|[^{}])*\}|[^{}])+\}))?|\{\s*\.{3}\s*[a-z_$][\w$]*(?:\.[a-z_$][\w$]*)*\s*\}))*\s*\/?)?>/i, Prism.languages.jsx.tag.inside.tag.pattern = /^<\/?[^\s>\/]*/i, Prism.languages.jsx.tag.inside['attr-value'].pattern = /=(?!\{)(?:"(?:\\[^]|[^\\"])*"|'(?:\\[^]|[^\\'])*'|[^\s'">]+)/i, Prism.languages.jsx.tag.inside.tag.inside['class-name'] = /^[A-Z]\w*(?:\.[A-Z]\w*)*$/, Prism.languages.insertBefore('inside', 'attr-name', {spread: {pattern: /\{\s*\.{3}\s*[a-z_$][\w$]*(?:\.[a-z_$][\w$]*)*\s*\}/, inside: {punctuation: /\.{3}|[{}.]/, 'attr-value': /\w+/}}}, Prism.languages.jsx.tag), Prism.languages.insertBefore('inside', 'attr-value', {script: {pattern: /=(?:\{(?:\{(?:\{[^{}]*\}|[^{}])*\}|[^{}])+\})/i, inside: {'script-punctuation': {pattern: /^=(?={)/, alias: 'punctuation'}, rest: Prism.languages.jsx}, alias: 'language-javascript'}}, Prism.languages.jsx.tag); var stringifyToken = function (token) {
	...
	'use strict'; function typescript(Prism) {
		!(function (Prism) {
			Prism.languages.typescript = Prism.languages.extend('javascript', {'class-name': {pattern: /(\b(?:class|extends|implements|instanceof|interface|new|type)\s+)(?!keyof\b)(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?:\s*<(?:[^<>]|<(?:[^<>]|<[^<>]*>)*>)*>)?/, lookbehind: !0, greedy: !0, inside: null}, keyword: /\b(?:abstract|as|asserts|async|await|break|case|catch|class|const|constructor|continue|debugger|declare|default|delete|do|else|enum|export|extends|finally|for|from|function|get|if|implements|import|in|instanceof|interface|is|keyof|let|module|namespace|new|null|of|package|private|protected|public|readonly|return|require|set|static|super|switch|this|throw|try|type|typeof|undefined|var|void|while|with|yield)\b/, builtin: /\b(?:string|Function|any|number|boolean|Array|symbol|console|Promise|unknown|never)\b/}), delete Prism.languages.typescript.parameter; let typeInside = Prism.languages.extend('typescript', {}); delete typeInside['class-name'], Prism.languages.typescript['class-name'].inside = typeInside, Prism.languages.insertBefore('typescript', 'function', {'generic-function': {pattern: /#?(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*\s*<(?:[^<>]|<(?:[^<>]|<[^<>]*>)*>)*>(?=\s*\()/, greedy: !0, inside: {function: /^#?(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*/, generic: {pattern: /<[\s\S]+/, alias: 'class-name', inside: typeInside}}}}), Prism.languages.ts = Prism.languages.typescript;
		})(Prism);
	}
	...
	'use strict'; (function (global) {
		...
		})(); ctx.Prism = {manual: !0, disableWorkerMessageHandler: !0}; let h = __webpack_require__(889); let decode = __webpack_require__(905); let Prism = __webpack_require__(912); let markup = __webpack_require__(879); let css = __webpack_require__(880); let clike = __webpack_require__(913); let js = __webpack_require__(914); restore(); let own = {}.hasOwnProperty; function Refractor() {}Refractor.prototype = Prism; let refract = new Refractor(); function register(grammar) {
	...
	'use strict'; module.exports = __webpack_require__(890);
}, 890(module, exports, __webpack_require__) {
	'use strict'; let schema = __webpack_require__(891); let html = __webpack_require__(900)(schema, 'div'); html.displayName = 'html', module.exports = html;
}, 891(module, exports, __webpack_require__) {
	'use strict'; let merge = __webpack_require__(892); let xlink = __webpack_require__(894); let xml = __webpack_require__(895); let xmlns = __webpack_require__(896); let aria = __webpack_require__(898); let html = __webpack_require__(899); module.exports = merge([xml, xlink, xmlns, aria, html]);
}, 892(module, exports, __webpack_require__) {
	'use strict'; let xtend = __webpack_require__(893); let Schema = __webpack_require__(874); module.exports = function merge(definitions) {
	...
	'use strict'; let create = __webpack_require__(871); module.exports = create({space: 'xlink', transform: function xlinkTransform(_, prop) {
	...
	'use strict'; let create = __webpack_require__(871); module.exports = create({space: 'xml', transform: function xmlTransform(_, prop) {
		return 'xml:' + prop.slice(3).toLowerCase();
	}, properties: {xmlLang: null, xmlBase: null, xmlSpace: null}});
}, 896(module, exports, __webpack_require__) {
	'use strict'; let create = __webpack_require__(871); let caseInsensitiveTransform = __webpack_require__(877); module.exports = create({space: 'xmlns', attributes: {xmlnsxlink: 'xmlns:xlink'}, transform: caseInsensitiveTransform, properties: {xmlns: null, xmlnsXLink: null}});
	...
	'use strict'; let types = __webpack_require__(873); let create = __webpack_require__(871); let {booleanish} = types; let {number} = types; let {spaceSeparated} = types; module.exports = create({transform: function ariaTransform(_, prop) {
	...
	'use strict'; let normalize = __webpack_require__(872); let DefinedInfo = __webpack_require__(875); let Info = __webpack_require__(876); module.exports = function find(schema, value) {
	...
	'use strict'; let legacy = __webpack_require__(906); let invalid = __webpack_require__(907); let decimal = __webpack_require__(878); let hexadecimal = __webpack_require__(908); let alphanumerical = __webpack_require__(909); let decodeEntity = __webpack_require__(911); module.exports = function parseEntities(value, options) {
	...
	'use strict'; let alphabetical = __webpack_require__(910); let decimal = __webpack_require__(878); module.exports = function alphanumerical(character) {
	...
	(function (global) {
		let Prism = (function (_self) {
			let lang = /\blang(?:uage)?-([\w-]+)\b/i; let uniqueId = 0; var _ = {manual: _self.Prism && _self.Prism.manual, disableWorkerMessageHandler: _self.Prism && _self.Prism.disableWorkerMessageHandler, util: {encode: function encode(tokens) {
	...
	let objectWithoutPropertiesLoose = __webpack_require__(916); module.exports = function _objectWithoutProperties(source, excluded) {
		if (source == null) {
			return {};
		}
	...
	'use strict'; let refractor_lang_js_extras_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(918); let refractor_lang_js_extras_js__WEBPACK_IMPORTED_MODULE_0___default = __webpack_require__.n(refractor_lang_js_extras_js__WEBPACK_IMPORTED_MODULE_0__); __webpack_exports__.a = refractor_lang_js_extras_js__WEBPACK_IMPORTED_MODULE_0___default.a;
	...
	'use strict'; let refractor_lang_jsx_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(882); let refractor_lang_jsx_js__WEBPACK_IMPORTED_MODULE_0___default = __webpack_require__.n(refractor_lang_jsx_js__WEBPACK_IMPORTED_MODULE_0__); __webpack_exports__.a = refractor_lang_jsx_js__WEBPACK_IMPORTED_MODULE_0___default.a;
}, 920(module, __webpack_exports__, __webpack_require__) {
	'use strict'; let refractor_lang_json_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(921); let refractor_lang_json_js__WEBPACK_IMPORTED_MODULE_0___default = __webpack_require__.n(refractor_lang_json_js__WEBPACK_IMPORTED_MODULE_0__); __webpack_exports__.a = refractor_lang_json_js__WEBPACK_IMPORTED_MODULE_0___default.a;
	...
	'use strict'; let refractor_lang_yaml_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(923); let refractor_lang_yaml_js__WEBPACK_IMPORTED_MODULE_0___default = __webpack_require__.n(refractor_lang_yaml_js__WEBPACK_IMPORTED_MODULE_0__); __webpack_exports__.a = refractor_lang_yaml_js__WEBPACK_IMPORTED_MODULE_0___default.a;
	...
	'use strict'; let refractor_lang_markdown_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(925); let refractor_lang_markdown_js__WEBPACK_IMPORTED_MODULE_0___default = __webpack_require__.n(refractor_lang_markdown_js__WEBPACK_IMPORTED_MODULE_0__); __webpack_exports__.a = refractor_lang_markdown_js__WEBPACK_IMPORTED_MODULE_0___default.a;
			...
			let tableCell = /(?:\\.|``(?:[^`\r\n]|`(?!`))+``|`[^`\r\n]+`|[^\\|\r\n`])+/.source; let tableRow = /\|?__(?:\|__)+\|?(?:(?:\n|\r\n?)|(?![\s\S]))/.source.replace(/__/g, (() => tableCell)); let tableLine = /\|?[ \t]*:?-{3,}:?[ \t]*(?:\|[ \t]*:?-{3,}:?[ \t]*)+\|?(?:\n|\r\n?)/.source; Prism.languages.markdown = Prism.languages.extend('markup', {}), Prism.languages.insertBefore('markdown', 'prolog', {'front-matter-block': {pattern: /(^(?:\s*[\r\n])?)---(?!.)[\s\S]*?[\r\n]---(?!.)/, lookbehind: !0, greedy: !0, inside: {punctuation: /^---|---$/, 'font-matter': {pattern: /\S+(?:\s+\S+)*/, alias: ['yaml', 'language-yaml'], inside: Prism.languages.yaml}}}, blockquote: {pattern: /^>(?:[\t ]*>)*/m, alias: 'punctuation'}, table: {pattern: RegExp('^' + tableRow + tableLine + '(?:' + tableRow + ')*', 'm'), inside: {'table-data-rows': {pattern: RegExp('^(' + tableRow + tableLine + ')(?:' + tableRow + ')*$'), lookbehind: !0, inside: {'table-data': {pattern: RegExp(tableCell), inside: Prism.languages.markdown}, punctuation: /\|/}}, 'table-line': {pattern: RegExp('^(' + tableRow + ')' + tableLine + '$'), lookbehind: !0, inside: {punctuation: /\||:?-{3,}:?/}}, 'table-header-row': {pattern: RegExp('^' + tableRow + '$'), inside: {'table-header': {pattern: RegExp(tableCell), alias: 'important', inside: Prism.languages.markdown}, punctuation: /\|/}}}}, code: [{pattern: /((?:^|\n)[ \t]*\n|(?:^|\r\n?)[ \t]*\r\n?)(?: {4}|\t).+(?:(?:\n|\r\n?)(?: {4}|\t).+)*/, lookbehind: !0, alias: 'keyword'}, {pattern: /``.+?``|`[^`\r\n]+`/, alias: 'keyword'}, {pattern: /^```[\s\S]*?^```$/m, greedy: !0, inside: {'code-block': {pattern: /^(```.*(?:\n|\r\n?))[\s\S]+?(?=(?:\n|\r\n?)^```$)/m, lookbehind: !0}, 'code-language': {pattern: /^(```).+/, lookbehind: !0}, punctuation: /```/}}], title: [{pattern: /\S.*(?:\n|\r\n?)(?:==+|--+)(?=[ \t]*$)/m, alias: 'important', inside: {punctuation: /==+$|--+$/}}, {pattern: /(^\s*)#.+/m, lookbehind: !0, alias: 'important', inside: {punctuation: /^#+|#+$/}}], hr: {pattern: /(^\s*)([*-])(?:[\t ]*\2){2,}(?=\s*$)/m, lookbehind: !0, alias: 'punctuation'}, list: {pattern: /(^\s*)(?:[*+-]|\d+\.)(?=[\t ].)/m, lookbehind: !0, alias: 'punctuation'}, 'url-reference': {pattern: /!?\[[^\]]+\]:[\t ]+(?:\S+|<(?:\\.|[^>\\])+>)(?:[\t ]+(?:"(?:\\.|[^"\\])*"|'(?:\\.|[^'\\])*'|\((?:\\.|[^)\\])*\)))?/, inside: {variable: {pattern: /^(!?\[)[^\]]+/, lookbehind: !0}, string: /(?:"(?:\\.|[^"\\])*"|'(?:\\.|[^'\\])*'|\((?:\\.|[^)\\])*\))$/, punctuation: /^[\[\]!:]|[<>]/}, alias: 'url'}, bold: {pattern: createInline(/\b__(?:(?!_)<inner>|_(?:(?!_)<inner>)+_)+__\b|\*\*(?:(?!\*)<inner>|\*(?:(?!\*)<inner>)+\*)+\*\*/.source), lookbehind: !0, greedy: !0, inside: {content: {pattern: /(^..)[\s\S]+(?=..$)/, lookbehind: !0, inside: {}}, punctuation: /\*\*|__/}}, italic: {pattern: createInline(/\b_(?:(?!_)<inner>|__(?:(?!_)<inner>)+__)+_\b|\*(?:(?!\*)<inner>|\*\*(?:(?!\*)<inner>)+\*\*)+\*/.source), lookbehind: !0, greedy: !0, inside: {content: {pattern: /(^.)[\s\S]+(?=.$)/, lookbehind: !0, inside: {}}, punctuation: /[*_]/}}, strike: {pattern: createInline(/(~~?)(?:(?!~)<inner>)+?\2/.source), lookbehind: !0, greedy: !0, inside: {content: {pattern: /(^~~?)[\s\S]+(?=\1$)/, lookbehind: !0, inside: {}}, punctuation: /~~?/}}, url: {pattern: createInline(/!?\[(?:(?!\])<inner>)+\](?:\([^\s)]+(?:[\t ]+"(?:\\.|[^"\\])*")?\)|[ \t]?\[(?:(?!\])<inner>)+\])/.source), lookbehind: !0, greedy: !0, inside: {operator: /^!/, content: {pattern: /(^\[)[^\]]+(?=\])/, lookbehind: !0, inside: {}}, variable: {pattern: /(^\][ \t]?\[)[^\]]+(?=\]$)/, lookbehind: !0}, url: {pattern: /(^\]\()[^\s)]+/, lookbehind: !0}, string: {pattern: /(^[ \t]+)"(?:\\.|[^"\\])*"(?=\)$)/, lookbehind: !0}}}}), ['url', 'bold', 'italic', 'strike'].forEach((token => {
				...
				if (env.type === 'code-block') {
					...
					let grammar = Prism.languages[codeLang]; if (grammar) {
						let code = env.content.value.replace(/&lt;/g, '<').replace(/&amp;/g, '&'); env.content = Prism.highlight(code, grammar, codeLang);
	...
	'use strict'; let refractor_lang_css_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(880); let refractor_lang_css_js__WEBPACK_IMPORTED_MODULE_0___default = __webpack_require__.n(refractor_lang_css_js__WEBPACK_IMPORTED_MODULE_0__); __webpack_exports__.a = refractor_lang_css_js__WEBPACK_IMPORTED_MODULE_0___default.a;
}, 929(module, __webpack_exports__, __webpack_require__) {
	'use strict'; let refractor_lang_markup_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(879); let refractor_lang_markup_js__WEBPACK_IMPORTED_MODULE_0___default = __webpack_require__.n(refractor_lang_markup_js__WEBPACK_IMPORTED_MODULE_0__); __webpack_exports__.a = refractor_lang_markup_js__WEBPACK_IMPORTED_MODULE_0___default.a;
}, 930(module, __webpack_exports__, __webpack_require__) {
	'use strict'; let refractor_lang_tsx_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(931); let refractor_lang_tsx_js__WEBPACK_IMPORTED_MODULE_0___default = __webpack_require__.n(refractor_lang_tsx_js__WEBPACK_IMPORTED_MODULE_0__); __webpack_exports__.a = refractor_lang_tsx_js__WEBPACK_IMPORTED_MODULE_0___default.a;
}, 931(module, exports, __webpack_require__) {
	'use strict'; let refractorJsx = __webpack_require__(882); let refractorTypescript = __webpack_require__(883); function tsx(Prism) {
	...
	'use strict'; let refractor_lang_typescript_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(883); let refractor_lang_typescript_js__WEBPACK_IMPORTED_MODULE_0___default = __webpack_require__.n(refractor_lang_typescript_js__WEBPACK_IMPORTED_MODULE_0__); __webpack_exports__.a = refractor_lang_typescript_js__WEBPACK_IMPORTED_MODULE_0___default.a;
}, 933(module, __webpack_exports__, __webpack_require__) {
	'use strict'; let refractor_lang_graphql_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(934); let refractor_lang_graphql_js__WEBPACK_IMPORTED_MODULE_0___default = __webpack_require__.n(refractor_lang_graphql_js__WEBPACK_IMPORTED_MODULE_0__); __webpack_exports__.a = refractor_lang_graphql_js__WEBPACK_IMPORTED_MODULE_0___default.a;
	...
	'use strict'; let objectWithoutProperties = __webpack_require__(915); let objectWithoutProperties_default = __webpack_require__.n(objectWithoutProperties); let objectSpread = __webpack_require__(881); let objectSpread_default = __webpack_require__.n(objectSpread); let react = __webpack_require__(0); let react_default = __webpack_require__.n(react); let helpers_extends = __webpack_require__(398); let extends_default = __webpack_require__.n(helpers_extends); function createStyleObject(classNames) {
	...
	let defaultAstGenerator; let defaultStyle; let core = __webpack_require__(888); let core_default = __webpack_require__.n(core); let prism_light_SyntaxHighlighter = (defaultAstGenerator = core_default.a, defaultStyle = {}, function SyntaxHighlighter(_ref7) {
